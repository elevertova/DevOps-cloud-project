...
resource "aws_instance" "frhn_dev_web_1" {
...
resource "aws_instance" "frhn_dev_web_2" {
  ami                    = "ami-066a7fbea5161f451"
  instance_type          = "t3.micro"
...
resource "aws_instance" "frhn-dev_1" {
  ami                    = "ami-066a7fbea5161f451"
  instance_type          = "t3.micro"
...
resource "aws_instance" "frhn-dev_2" {
  ami                    = "ami-066a7fbea5161f451"
  instance_type          = "t3.micro"
...
# resource "aws_lambda_function" "frhn-dev_lambda" {
#   function_name = "frhn-dev-app-lambda"
...
#   s3_bucket = "frhn-dev-app2"           # Correct bucket name
...
#         ],
#         Resource = [
#           "arn:aws:s3:::frhn-dev-app2",                    # Allow access to the bucket
#           "arn:aws:s3:::frhn-dev-app2/lambda.zip"          # Allow access to the specific object
#         ]
#       }
#     ]
#   })
