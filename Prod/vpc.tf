...
resource "aws_vpc" "frhn_prod_app" {
  cidr_block = "10.0.0.0/16"

  tags = {
    Name = "frhn-prod-app-vpc"
  }
}

# App Tier VPC (private resources)
resource "aws_vpc" "frhn-prod" {
...
resource "aws_internet_gateway" "frhn_prod_app_igw" {
  vpc_id = aws_vpc.frhn_prod_app.id

  tags = {
    Name = "frhn-prod-app-igw"
  }
}
...
resource "aws_route_table" "public_rt" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.frhn_prod_app_igw.id
  }

  tags = {
    Name = "frhn-prod-app-public-rt"
  }
}
...
resource "aws_subnet" "public_subnet_1" {
  ...
  tags = {
    Name = "frhn-prod-app-public-subnet-1"
  }
}
...
resource "aws_subnet" "public_subnet_2" {
  ...
  tags = {
    Name = "frhn-prod-app-public-subnet-2"
  }
}
...
resource "aws_subnet" "private_subnet_1" {
  ...
  tags = {
    Name = "frhn-prod-private-subnet-1"
  }
}
...
resource "aws_subnet" "private_subnet_2" {
  ...
  tags = {
    Name = "frhn-prod-private-subnet-2"
  }
}
